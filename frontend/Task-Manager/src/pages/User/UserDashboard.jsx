    ...
    const getDashboardData = async () => {
        try {
            ...
            if (response.data) {
                ...
                prepareChartData(response.data?.charts || response.data);
            }
        ...
        <div className="card my-5">
            <div>
                <div className="col-span-3">
                    <h2 className="text-xl md:text-2xl">{(() => { const h = new Date().getHours(); return h < 12 ? "Good Morning" : h < 18 ? "Good Afternoon" : "Good Evening"; })()}! {user?.name}</h2>
